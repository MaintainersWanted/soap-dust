...
public class Handler extends URLStreamHandler {
	...
	private static Map<String, HttpServlet> register = new HashMap<String, HttpServlet>();
	public static void clearRegister() {
		register = new HashMap<String, HttpServlet>();
	}
	public static void register(String name, HttpServlet servlet) {
		register.put(name, servlet);
	}
